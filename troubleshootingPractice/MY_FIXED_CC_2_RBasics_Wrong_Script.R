...
# wrong script work where I catch/fix R issues provided by coding club
...
barplot(biodiv, xlab="Taxa", ylab="Number of Species", ylim=c(0,600),
        cex.names=0.75, cex.axis=0.75, cex.lab=1.5)
...
png("barplotFromWrong.png", width=1600, height=600)
barplot(biodiv, xlab="Taxa", ylab="Number of species", ylim=c(0,600),
        cex.names=0.75, cex.axis=0.75, cex.lab=1.5)
dev.off()
...
write.csv(biodata, file="biodataFromwrong.csv")
...
png("barplot2FromWrong.png", width=950, height=500)
